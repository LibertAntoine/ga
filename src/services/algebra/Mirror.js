    ...
    intersect(ray) { return this.algebra.inline((point1, point2, ray)=>
        {
            ...
            return [ intersect&&sameside, (ray[1] & ipoint).Length, ipoint, mirror >>> ray[0] ]
        })(this.point1, this.point2, ray)
    }
    
    render(){ return [this.color, (typeof(this.point1) == "object")?this.point1:undefined, (typeof(this.point2) == "object")?this.point2:undefined, '<G stroke-width="0.08" opacity="1" filter="url(#mirror)" stroke-dashoffset="0" stroke-dasharray="0.01, 0.03"  opacity="1"  >', [this.point1,this.point2], '</G>']}
}

module.exports = {PlaneMirror}
